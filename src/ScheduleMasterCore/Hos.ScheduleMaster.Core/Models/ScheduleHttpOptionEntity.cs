...
namespace Hos.ScheduleMaster.Core.Models
{
    ...
    public class ScheduleHttpOptionEntity : IEntity
    {
        ...
        /// 请求地址
        /// </summary>
        [Column("requesturl", TypeName = "varchar(500)"), MaxLength(500), Required]
        ...
        /// 请求方式
        /// </summary>
        [Column("method", TypeName = "varchar(10)"), MaxLength(10), Required]        
        ...
        /// 数据格式
        /// </summary>
        [Column("contenttype", TypeName = "varchar(50)"), MaxLength(50), Required]
