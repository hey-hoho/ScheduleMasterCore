...
namespace Hos.ScheduleMaster.Core.Models
{
    ...
    public class ScheduleDelayedEntity : IEntity
    {
        ...
        [Column("sourceapp", TypeName = "varchar(50)")]
        ...
        /// </summary>
        [Required, MaxLength(100)]
        [Column("contentkey", TypeName = "varchar(100)")]
        ...
        [Column("notifyurl", TypeName = "varchar(255)")]
        ...
        /// </summary>
        [Required, MaxLength(50)]
        [Column("notifydatatype", TypeName = "varchar(255)")]
        ...
        [Column("notifybody", TypeName = "varchar(1000)")]
